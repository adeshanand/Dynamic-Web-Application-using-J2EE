...
public final class studentFound1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try {
    ...
    if(rs.next()){
      ...
      out.write("<table align=\"center\">\r\n");
      out.write("<tr><td>Type Book ID</td><td><input type=\"text\" name=\"sids\" placeholder=\"Case Sensitive\" title=\"Choose Student ID from the above table and type its ID here to show it\" /></td><td><input type=\"submit\" value=\"Go\" /></td></tr>\r\n");
      out.write("</table>\r\n");
      out.write("</form>\r\n");

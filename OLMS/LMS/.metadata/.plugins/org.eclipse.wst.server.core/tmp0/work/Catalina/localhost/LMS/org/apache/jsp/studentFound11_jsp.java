 ...
 * Generated at: 2014-05-25 06:32:02 UTC
...
public final class studentFound11_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(State == 2){
      ...
      out.write("<form action=\"studentFound1.jsp\" method=\"post\" >\r\n");
      ...
      out.write("<br />\r\n");
      out.write("<br />\r\n");
      out.write("<form action=\"studentFound2.jsp\" method=\"post\" >\r\n");
      out.write("<table align=\"center\">\r\n");
      out.write("<tr><td>Type Student ID</td><td><input type=\"text\" name=\"sids\" placeholder=\"Case Sensitive\" title=\"Choose Student ID from the above table and type its ID here to show it\" /></td><td><input type=\"submit\" value=\"Go\" /></td></tr>\r\n");
      out.write("</table>\r\n");
      out.write("</form>\r\n");
      out.write("<br />\r\n");
...
if(State == 3){
      ...
      out.write(" \r\n");
      out.write("\t<div style=\"font-style: italic; text-align: center; font-weight: 600;\"> You have typed an incorrect Student ID. </div> \r\n");
      out.write("\t");

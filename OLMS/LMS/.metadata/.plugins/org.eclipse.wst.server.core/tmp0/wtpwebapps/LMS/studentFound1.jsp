...
try {
    ...
    if(rs.next()){
        ...
        e.printStackTrace();
        System.out.println("ERROR OCCURED WHILE PROCESSING studentFound1.jsp");
...
<table align="center">
<tr><td>Type Book ID</td><td><input type="text" name="sids" placeholder="Case Sensitive" title="Choose Student ID from the above table and type its ID here to show it" /></td><td><input type="submit" value="Go" /></td></tr>
</table>
</form>

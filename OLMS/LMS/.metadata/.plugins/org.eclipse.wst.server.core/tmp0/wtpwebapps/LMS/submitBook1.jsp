...
if(State == 2){
	%>
	<div style="margin-left: 20px; text-align: left; font-style: italic; font-weight: 600;">The Book ID you entered is not issued to any Student. </div>
	<%
}
if(State == 3){
	%>
	<div style="margin-right:20px; text-align:right; font-size:20px;font-weight: 600;padding-bottom: 25px;"> Book Submitted Successfully! </div>
	<%
}
%>

...
if(errorState==1){
	%>
	<div style="text-align:center; padding:20px;">INCORRECT USER ID </div>
	<%
}
if(errorState==2){
	%>
	<div style="text-align:center; padding:20px;">INCORRECT PASSWORD <br />If you forgot your password, consult to the Administrator-Group-Member  to reset it. </div>
	<%
}
%>

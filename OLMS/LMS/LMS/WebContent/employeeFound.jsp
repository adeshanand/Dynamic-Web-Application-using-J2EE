...
<form action="employeeFound1.jsp" method="post" >
<table align="center">
...
try {
    ...
    if(rs.next()){
    	...
    	request.getRequestDispatcher("searchEmployee1.jsp").forward(request, response);
    }
    }catch(Exception e){
        e.printStackTrace();
        System.out.println("ERROR OCCURED WHILE PROCESSING employeeFound.jsp");
...
<br />
<form action="employeeFound2.jsp" method="post" >
<table align="center">
<tr><td>Type Employee ID</td><td><input type="text" name="eids" placeholder="Case Sensitive" title="Choose Employee ID from the above table and type its ID here to show it" /></td><td><input type="submit" value="Go" /></td></tr>
</table>
</form>
